...
// Junk movedso join precedes it
    ...
    { "editor",         do_editor,      POSITION_SLEEPING, 100, 9, 0, 1 },
    ...
    { "lastprompt",	do_lastprompt,	POSITION_DEAD, 0, 9, 0, 1 },
    ...
    { "huntitems",       do_showhunt,    POSITION_RESTING, 0, 9, 0, 0},
    ...
    { "huntclear",      do_huntclear,   POSITION_DEAD, 105, 9, 0, 1 },
    { "huntstart",      do_huntstart,   POSITION_DEAD, 105, 9, 0, 1 },
    ...
    { "testport",	do_testport,	POSITION_DEAD, GIFTED_COMMAND, 9, 0, 1 },
    ...
    { "motdload",       do_motdload,    POSITION_DEAD, IMP, 9, 0, 1 },
    ...
    { "guild",          do_guild,       POSITION_DEAD, ANGEL, 9, 0, 1 },
    ...
    { "matrixinfo",     do_matrixinfo, POSITION_DEAD, 103, 9, 0, 1},
    ...
    { "testhit",	do_testhit,     POSITION_DEAD, 110, 9, 0, 1},
    { "acfinder",       do_acfinder,    POSITION_DEAD, 108, 9, 0, 1},
    ...
    { "mphit",			do_mphit,	POSITION_DEAD, 0, 9, 0, 1 },
    { "mpaddlag",		do_mpaddlag,	POSITION_DEAD, 0, 9, 0, 1 },
    ...
    { "mppeace",		do_mppeace,	POSITION_DEAD, 0, 9, 0, 1 },
    ...
    { "mpretval",               do_mpretval,	POSITION_DEAD, 0, 9, 0, 1 },
    { "mpsetmath",		do_mpsetmath,	POSITION_DEAD, 0, 9, 0, 1 },
    { "mpteleport",	        do_mpteleport,	POSITION_DEAD, 0, 9, 0, 1 },
