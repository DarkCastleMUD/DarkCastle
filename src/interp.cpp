...
struct command_info cmd_info[] =
{
    ...
    { "get",		do_get,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 25 },
    ...
    { "ask",		do_ask,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 1 },
    { "auction",	do_auction,	POSITION_RESTING, 0, 9, 0, 1 },
    { "channel",	do_channel,	POSITION_DEAD, 0, 9, 0, 1 },
    { "dream",		do_dream,	POSITION_DEAD, 0, 9, 0, 1 },
    { "emote",		do_emote,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 1 },
    { ":",		do_emote,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 1 },    
    ...
    { "insult",		do_insult,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 1 },
    { "reply",		do_reply,	POSITION_RESTING, 0, 9, 0, 1 },
    { "report",		do_report,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 1 },
    ...
    { "put",		do_put,		POSITION_RESTING, 0, 93, COM_CHARMIE_OK, 25 },
    ...
    { "track",		do_track,	POSITION_STANDING, 0, 10, 0, 25 },
    { "take",		do_get,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 25 },
    { "palm",		do_get,		POSITION_RESTING, 3, 10, 0, 25 },
    ...
    { "golemscore",	do_golem_score,	POSITION_DEAD, 1, 9, 0, 0 },
    ...
    { "enter",		do_enter,	POSITION_STANDING, 0, 60, COM_CHARMIE_OK, 25 },
    { "climb",		do_climb,	POSITION_STANDING, 0, 60, COM_CHARMIE_OK, 25 },
    ...
    { "leave",		do_leave,	POSITION_STANDING, 0, 187, COM_CHARMIE_OK, 25 },
    { "name",		do_name,	POSITION_DEAD, 1, 9, 0, 1 },
    { "pick",		do_pick,	POSITION_STANDING, 0, 35, 0, 25 },
