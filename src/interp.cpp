...
/***************************************************************************/
/* $Id: interp.cpp,v 1.73 2006/01/23 21:27:20 eas Exp $ */
...
struct command_info cmd_info[] =
{
    ...
    { "f",		do_fire,	POSITION_FIGHTING, 1, 9, 0, 20 },
    { "get",		do_get,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    ...
    { "scan",		do_scan,	POSITION_RESTING, 1, 9, 0, 20 },
    { "stand",		do_stand,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 0 },
    { "switch",		do_switch,	POSITION_RESTING, 0, 9, 0, 20 },
    { "tell",		do_tell,	POSITION_RESTING, 0, 9, 0, 1 },
    { "wield",		do_wield,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    ...
    { "tick",		do_tick,	POSITION_DEAD, 0, 9, 0, 1 },
    ...
    { "social",		do_social,	POSITION_DEAD, 0, 9, 0, 1 },
    ...
    // Object manipulation
    { "slip",		do_slip,	POSITION_STANDING, 0,  87, 0, 10 },
    { "close",		do_close,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "donate",		do_donate,	POSITION_RESTING, 0, 90, COM_CHARMIE_OK, 1 },
    { "drink",		do_drink,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "drop",		do_drop,	POSITION_RESTING, 0, 89, COM_CHARMIE_OK, 20 },
    { "eat",		do_eat,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "fill",		do_fill,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "give",		do_give,	POSITION_RESTING, 0, 88, COM_CHARMIE_OK, 20 },
    { "grab",		do_grab,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "hold",		do_grab,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "lock",		do_lock,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "open",		do_open,	POSITION_RESTING, 0, 98, COM_CHARMIE_OK, 20 },
    { "pour",		do_pour,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "put",		do_put,		POSITION_RESTING, 0, 93, COM_CHARMIE_OK, 20 },
    { "quaff",		do_quaff,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "read",		do_read,	POSITION_RESTING, 0, 67, 0, 1 },
    { "remove",		do_remove,	POSITION_RESTING, 0, 69, COM_CHARMIE_OK, 20 },
    { "erase",		do_not_here,	POSITION_RESTING, 0, 70, 0, 0 },
    { "sip",		do_sip,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "track",		do_track,	POSITION_STANDING, 0, 10, 0, 20 },
    { "take",		do_get,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "palm",		do_get,		POSITION_RESTING, 3, 10, 0, 20 },
    { "junk",		do_tap,		POSITION_RESTING, 0, 92, COM_CHARMIE_OK, 20 },
    { "sacrifice",	do_tap,		POSITION_RESTING, 0, 92, COM_CHARMIE_OK, 20 },
    { "taste",		do_taste,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "unlock",		do_unlock,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "use",		do_use,		POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    { "wear",		do_wear,	POSITION_RESTING, 0, 9, COM_CHARMIE_OK, 20 },
    //  { "poisonmaking", do_poisonmaking, POSITION_RESTING, 0, 9,   0, 0 },
    
    // Combat commands
    { "bash",		do_bash,	POSITION_FIGHTING, 0, 9, 0, 1 },
    { "retreat",	do_retreat,	POSITION_FIGHTING, 0, 9, 0, 1 },
    { "disarm",		do_disarm,	POSITION_FIGHTING, 2, 9, 0, 1 },
    { "flee",		do_flee,	POSITION_FIGHTING, 0, 28, COM_CHARMIE_OK, 0 }, 
    { "hit",		do_hit,		POSITION_FIGHTING, 0, 9, COM_CHARMIE_OK, 1 },
    { "join",		do_join,	POSITION_FIGHTING, 0, 9, COM_CHARMIE_OK, 1 },
    { "murder",		do_murder,	POSITION_FIGHTING, 0, 9, COM_CHARMIE_OK, 1 },
    { "rescue",		do_rescue,	POSITION_FIGHTING, 0, 9, 0, 1 },
    { "trip",		do_trip,	POSITION_FIGHTING, 0, 9, 0, 1 },
    { "deathstroke",	do_deathstroke,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "circle",		do_circle,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "kick",		do_kick,	POSITION_FIGHTING, 0, 9, 0, 1 },
    { "battlecry",	do_battlecry,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "rage",		do_rage,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "berserk",	do_berserk,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "golemscore",	do_golem_score,	POSITION_DEAD, 1, 9, 0, 1 },
    { "stun",		do_stun,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "redirect",	do_redirect,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "hitall",		do_hitall,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "quiveringpalm",	do_quivering_palm,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "eagleclaw",	do_eagle_claw,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "headbutt",	do_headbutt,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "fire",		do_fire,	POSITION_FIGHTING, 1, 9, 0, 25 },
    { "layhands",	do_layhands,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "harmtouch",	do_harmtouch,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "bloodfury",	do_bloodfury,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "bladeshield",	do_bladeshield,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "repelance",	do_focused_repelance,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "vitalstrike",	do_vitalstrike,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "crazedassault",	do_crazedassault,	POSITION_FIGHTING, 1, 9, 0, 1 },
    { "bullrush",	do_bullrush,	POSITION_STANDING, 1, 9, 0, 1 },
    { "ferocity",	do_ferocity,	POSITION_STANDING, 1, 9, 0, 1 },
    { "tactics",	do_tactics,	POSITION_STANDING, 1, 9, 0, 1 },
    { "deceit",		do_deceit,	POSITION_STANDING, 1, 9, 0, 1 },
    { "knockback",	do_knockback,	POSITION_FIGHTING, 1, 9, 0, 1 },
    ...
    { "backstab",	do_backstab,	POSITION_STANDING, 0, 9, 0, 1 },
    { "bs",		do_backstab,	POSITION_STANDING, 0, 9, 0, 1 },
    { "boss",		do_boss,	POSITION_DEAD, 0, 9, 0, 1 },
    { "blackjack",	do_blackjack,	POSITION_STANDING, 0, 9, 0, 1 },
    ...
    { "eyegouge",	do_eyegouge,	POSITION_FIGHTING, 0, 9, 0, 1 },
    ...
    { "at",		do_at,		POSITION_DEAD, GIFTED_COMMAND, 9 , 0, 1 }, 
    ...
    { "install",	do_install,	POSITION_DEAD, GIFTED_COMMAND, 9, 0, 1 },
