...
/***************************************************************************/
/* $Id: interp.cpp,v 1.157 2008/11/21 02:59:51 dcastle Exp $ */
...
// Junk movedso join precedes it
    ...
    { "vote",		do_vote,	POSITION_RESTING, 51, CMD_VOTE, 0, 0},
    ...
    // Immortal commands
    { "voteset",	do_setvote,	POSITION_DEAD, IMMORTAL, CMD_SETVOTE, 0, 1},
    ...
    { "whattonerf",	do_maxes,	POSITION_DEAD, GIFTED_COMMAND, CMD_DEFAULT, 0, 1 },
    { "affclear",	do_clearaff,	POSITION_DEAD, 104, CMD_DEFAULT, 0, 1 },
    { "guide",		do_guide,	POSITION_DEAD, OVERSEER, CMD_DEFAULT, 0, 1 },
    ...
    { "slay",		do_kill,	POSITION_DEAD, OVERSEER, CMD_DEFAULT, 0, 1 },
    { "rename",		do_rename_char,	POSITION_DEAD, GIFTED_COMMAND, CMD_DEFAULT, 0, 1 },
    ...
    { "disconnect",	do_disconnect,	POSITION_DEAD, OVERSEER, CMD_DEFAULT, 0, 1 },  
    ...
    { "check",		do_check,	POSITION_DEAD, 104, CMD_DEFAULT, 0, 1 },
    ...
    { "possess",	do_possess,	POSITION_DEAD, GIFTED_COMMAND, CMD_DEFAULT,  0, 1 },
    { "fsave",		do_fsave,	POSITION_DEAD, ANGEL, CMD_DEFAULT, 0, 1 },
    ...
    { "sqsave",		do_write_skillquest,	POSITION_DEAD, GIFTED_COMMAND, CMD_DEFAULT, 0, 1 },
    { "testhand",       do_testhand,    POSITION_DEAD, GIFTED_COMMAND, CMD_DEFAULT, 0, 1},    
    { "varstat",		do_varstat,	POSITION_DEAD, 103, CMD_DEFAULT, 0, 1 },
    { "matrixinfo",     do_matrixinfo, POSITION_DEAD, 103, CMD_DEFAULT, 0, 1},
    { "maxcheck", do_findfix, POSITION_DEAD, IMMORTAL, CMD_DEFAULT, 0, 1 },
