...
/***************************************************************************/
/* $Id: interp.cpp,v 1.67 2005/06/04 10:56:23 dcastle Exp $ */
...
//    { "newbie",     do_newbie,      POSITION_DEAD,      0,  9,  0 },    
    ...
    { "flee",       do_flee,        POSITION_FIGHTING,  0,  28,  COM_CHARMIE_OK }, 
    { "hit",        do_hit,         POSITION_FIGHTING,  0,  9,  COM_CHARMIE_OK },
    { "join",       do_join,        POSITION_FIGHTING,  0,  9,  COM_CHARMIE_OK },
    { "murder",     do_murder,      POSITION_FIGHTING,  0,  9,  COM_CHARMIE_OK },
    ...
    { "golemscore", do_golem_score, POSITION_DEAD,  1,  9,  0 },
    ...
    { "ferocity",   do_ferocity,    POSITION_STANDING,  1,  9,  0 },
    { "tactics",    do_tactics,     POSITION_STANDING,  1,  9,  0 },
    { "deceit",     do_deceit,      POSITION_STANDING,  1,  9,  0 },
    { "knockback",  do_knockback,   POSITION_FIGHTING,  1,  9,  0 },
    { "appraise",   do_appraise,    POSITION_STANDING,  1,  9,  0 },
    ...
    { "blackjack",  do_blackjack,   POSITION_STANDING,  0,  9,  0 },
    ...
    { "cbalance", do_cbalance, POSITION_STANDING, 0, 9, 0 },
    { "cdeposit", do_cdeposit, POSITION_STANDING, 0, 9, 0},
    { "cwithdraw", do_cwithdraw, POSITION_STANDING, 0, 9, 0},
    { "ctax", do_ctax, POSITION_STANDING, 0, 9, 0},
    ...
    { "release",do_release,POSITION_STANDING,0,9,0},
    { "eyegouge", do_eyegouge, POSITION_FIGHTING, 0,9,0 },
    /*
...
/* spec proc commands placed so they don't effect god commands */
    ...
    { "do_the_thing", do_thing, POSITION_DEAD, 110, 9, 0},
