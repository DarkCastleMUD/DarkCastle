...
class Object *get_obj_in_list_vis(Character *ch, QString name, class Object *list, bool blindfighting = false);
class Object *get_obj_in_list_vis(Character *ch, const char *name, class Object *list, bool bf = false);
class Object *get_obj_in_list_vis(Character *ch, int item_num, class Object *list, bool bf = false);

class Object *get_obj_vis(Character *ch, QString name, bool loc = false);
