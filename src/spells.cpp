...
struct spell_info_type spell_info [ ] =
{
 ...
 { /* 01 */ 12, POSITION_STANDING,  8, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_armor },

 { /* 02 */ 12, POSITION_FIGHTING, 35, TAR_SELF_ONLY|TAR_SELF_DEFAULT, 
cast_teleport },

 { /* 03 */ 12, POSITION_STANDING,  6, 
TAR_CHAR_ROOM|TAR_SELF_DEFAULT|TAR_OBJ_INV|TAR_OBJ_ROOM|TAR_OBJ_EQUIP, 
cast_bless },

 { /* 04 */ 12, POSITION_FIGHTING, 20, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_blindness },

 { /* 05 */ 12, POSITION_FIGHTING, 15, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_burning_hands },

 { /* 06 */ 12, POSITION_FIGHTING, 35, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_call_lightning },

 { /* 07 */ /* 18, POSITION_STANDING, 15, TAR_CHAR_ROOM|TAR_SELF_NONO, 
cast_charm_person */ 0, 0, 0, 0, 0 },

 { /* 08 */ 12, POSITION_FIGHTING, 20, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_chill_touch },

 { /* 09 */ /* 12, POSITION_STANDING, 40, TAR_CHAR_ROOM, cast_clone); */ 
0, 0, 0, 0, 0 },

 { /* 10 */ 12, POSITION_FIGHTING, 40, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_colour_spray },

 { /* 11 */ 18, POSITION_STANDING, 25, TAR_IGNORE, cast_control_weather },

 { /* 12 */ 18, POSITION_STANDING,  5, TAR_IGNORE, cast_create_food },

 { /* 13 */ 18, POSITION_STANDING,  5, TAR_OBJ_INV|TAR_OBJ_EQUIP, 
cast_create_water },

 { /* 14 */ 12, POSITION_STANDING, 15, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_cure_blind },

 { /* 15 */ 12, POSITION_FIGHTING, 20, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_cure_critic },

 { /* 16 */ 12, POSITION_FIGHTING, 10, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_cure_light },
...
cast_detect_evil },
 ...
 { /* 19 */ 12, POSITION_STANDING,  8, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_detect_invisibility },

 { /* 20 */ 12, POSITION_STANDING,  6, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_detect_magic },
...
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_dispel_evil },
 ...
 { /* 24 */ 24, POSITION_STANDING, 50, TAR_OBJ_INV|TAR_OBJ_EQUIP, 
cast_enchant_weapon },

 { /* 25 */ 12, POSITION_FIGHTING, 20, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_energy_drain },

 { /* 26 */ 12, POSITION_FIGHTING, 25, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_fireball },

 { /* 27 */ 12, POSITION_FIGHTING, 33, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_harm },

 { /* 28 */ 12, POSITION_FIGHTING, 40, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_heal },

 { /* 29 */ 12, POSITION_STANDING,  7, 
TAR_CHAR_ROOM|TAR_OBJ_INV|TAR_OBJ_ROOM|TAR_OBJ_EQUIP|TAR_SELF_DEFAULT, 
cast_invisibility },

 { /* 30 */ 12, POSITION_FIGHTING, 17, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_lightning_bolt },
 ...
 { /* 32 */ 12, POSITION_FIGHTING, 10, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_magic_missile },

 { /* 33 */ 12, POSITION_STANDING, 15, 
TAR_CHAR_ROOM|TAR_SELF_NONO|TAR_OBJ_INV|TAR_OBJ_ROOM, cast_poison },

 { /* 34 */ 12, POSITION_STANDING, 50, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_protection_from_evil },

 { /* 35 */ 12, POSITION_STANDING, 18, 
TAR_CHAR_ROOM|TAR_OBJ_INV|TAR_OBJ_EQUIP|TAR_OBJ_ROOM, cast_remove_curse },

 { /* 36 */ 12, POSITION_STANDING, 60, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_sanctuary },

 { /* 37 */ 12, POSITION_FIGHTING, 15, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_shocking_grasp },

 { /* 38 */ 12, POSITION_STANDING, 33, TAR_CHAR_ROOM|TAR_SELF_NONO, 
cast_sleep },

 { /* 39 */ 12, POSITION_STANDING, 20, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_strength },

 { /* 40 */ 12, POSITION_FIGHTING, 50, TAR_CHAR_WORLD|TAR_SELF_NONO, 
cast_summon },

 { /* 41 */ 12, POSITION_FIGHTING,  5, 
TAR_CHAR_ROOM|TAR_OBJ_ROOM|TAR_SELF_NONO, cast_ventriloquate },

 { /* 42 */ 12, POSITION_FIGHTING, 50, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_word_of_recall },

 { /* 43 */ 12, POSITION_STANDING, 12, 
TAR_CHAR_ROOM|TAR_OBJ_INV|TAR_OBJ_ROOM|TAR_SELF_DEFAULT, 
cast_remove_poison },

 { /* 44 */ 12, POSITION_STANDING, 15, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_sense_life },

 { /* 45 */ 12, POSITION_STANDING, 45, TAR_IGNORE, cast_summon_familiar },

 { /* 46 */ 12, POSITION_STANDING, 30, TAR_IGNORE, cast_lighted_path },

 { /* 47 */ 12, POSITION_STANDING, 33, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_resist_acid },

 { /* 48 */ 12, POSITION_FIGHTING, 35, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_sun_ray },

 { /* 49 */ 12, POSITION_STANDING, 30, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_rapid_mend },

 { /* 50 */ 18, POSITION_STANDING, 120, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_acid_shield },

 { /* 51 */ 12, POSITION_STANDING, 22, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_water_breathing },

 { /* 52 */ 12, POSITION_FIGHTING, 20, TAR_IGNORE, cast_globe_of_darkness 
},

 { /* 53 */ 24, POSITION_STANDING, 12, 
TAR_CHAR_ROOM|TAR_OBJ_INV|TAR_OBJ_ROOM, cast_identify },
    
 { /* 54 */ 24, POSITION_STANDING, 75, TAR_OBJ_ROOM, cast_animate_dead },

 { /* 55 */ 12, POSITION_FIGHTING, 17, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_fear },

 { /* 56 */ 12, POSITION_STANDING, 10, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_fly },

 { /* 57 */ 12, POSITION_STANDING,  7, 
TAR_NONE_OK|TAR_OBJ_INV|TAR_OBJ_ROOM, cast_cont_light },

 { /* 58 */ 12, POSITION_STANDING,  5, TAR_CHAR_ROOM, cast_know_alignment 
},

 { /* 59 */ 12, POSITION_FIGHTING, 28, TAR_CHAR_ROOM|TAR_FIGHT_VICT, 
cast_dispel_magic },

 { /* 60 */ /* 24, POSITION_STANDING, 150, TAR_NONE_OK, 
cast_conjure_elemental */ 0, 0, 0, 0, 0 },

 { /* 61 */ 12, POSITION_FIGHTING, 15, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_cure_serious },

 { /* 62 */ 12, POSITION_FIGHTING, 12, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_cause_light },

 { /* 63 */ 12, POSITION_FIGHTING, 24, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_cause_critical },

 { /* 64 */ 12, POSITION_FIGHTING, 18, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_cause_serious },

 { /* 65 */ 12, POSITION_FIGHTING, 45, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_flamestrike },

 { /* 66 */ 12, POSITION_STANDING, 33, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_stone_skin },

 { /* 67 */ 12, POSITION_STANDING, 12, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_shield },

 { /* 68 */ 12, POSITION_FIGHTING, 20, TAR_CHAR_ROOM|TAR_FIGHT_VICT, 
cast_weaken },

 { /* 69 */ 24, POSITION_STANDING, 33, TAR_IGNORE, cast_mass_invis },

 { /* 70 */ 12, POSITION_FIGHTING, 45, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_acid_blast },

 { /* 71 */ 12, POSITION_STANDING, 55, TAR_CHAR_WORLD, cast_portal },

 { /* 72 */ 12, POSITION_STANDING,  7, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_infravision },

 { /* 73 */ 12, POSITION_STANDING, 12, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_refresh },

 { /* 74 */ 12, POSITION_STANDING, 33, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_haste },

 { /* 75 */ 12, POSITION_FIGHTING, 25, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_dispel_good },

 { /* 76 */ 12, POSITION_FIGHTING, 80, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_hellstream },

 { /* 77 */ 12, POSITION_FIGHTING, 60, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_power_heal },

 { /* 78 */ 12, POSITION_FIGHTING, 80, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_full_heal },

 { /* 79 */ 12, POSITION_FIGHTING, 55, TAR_IGNORE, cast_firestorm },

 { /* 80 */ 12, POSITION_FIGHTING, 45, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_power_harm },

 { /* 81 */ 12, POSITION_STANDING,  5, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_detect_good },

 { /* 82 */ 12, POSITION_FIGHTING, 33, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_vampiric_touch },

 { /* 83 */ 12, POSITION_FIGHTING, 40, TAR_IGNORE, cast_life_leech },

 { /* 84 */ 12, POSITION_FIGHTING, 33, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_paralyze },

 { /* 85 */ 12, POSITION_STANDING, 18, TAR_CHAR_ROOM, 
cast_remove_paralysis },

 { /* 86 */ 18, POSITION_STANDING, 160, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_fireshield },

 { /* 87 */ 12, POSITION_FIGHTING, 40, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_meteor_swarm },

 { /* 88 */ 12, POSITION_STANDING, 20, TAR_CHAR_WORLD, cast_wizard_eye },

 { /* 89 */ 12, POSITION_STANDING, 33, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_true_sight },

 { /* 90 */ 12, POSITION_STANDING,  0, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_mana },
 ...
 { /* 97 */ /* 24, POSITION_STANDING, 250, TAR_OBJ_INV|TAR_OBJ_EQUIP, 
cast_enchant_armor */ 0, 0, 0, 0, 0 },

 { /* 98 */ 12, POSITION_STANDING, 33, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_resist_fire },

 { /* 99 */ 12, POSITION_STANDING, 33, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_resist_cold },

 { /* 100 */ 12, POSITION_FIGHTING, 8, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_bee_sting }, 

 { /* 101 */ 12, POSITION_FIGHTING, 25, TAR_IGNORE, cast_bee_swarm }, 

 { /* 102 */ 12, POSITION_FIGHTING, 45, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_creeping_death }, 

 { /* 103 */ 12, POSITION_STANDING, 20, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_barkskin }, 

 { /* 104 */ 12, POSITION_FIGHTING, 45, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_herb_lore }, 

 { /* 105 */ 12, POSITION_STANDING, 75, TAR_IGNORE, cast_call_follower }, 

 { /* 106 */ 12, POSITION_FIGHTING, 15, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_entangle }, 

 { /* 107 */ 12, POSITION_STANDING,  5, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_eyes_of_the_owl },

 { /* 108 */ 12, POSITION_STANDING, 20, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_feline_agility }, 

 { /* 109 */ 12, POSITION_STANDING, 30, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_forest_meld },

 { /* 110 */ /* 12, POSITION_STANDING, 150, TAR_IGNORE, cast_companion */ 
0, 0, 0, 0, 0 },

 { /* 111 */ 12, POSITION_FIGHTING, 33, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_drown },

 { /* 112 */ 12, POSITION_FIGHTING, 25, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_howl },

 { /* 113 */ 12, POSITION_FIGHTING, 25, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_souldrain },

 { /* 114 */ 12, POSITION_FIGHTING, 18, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_sparks },

 { /* 115 */ 12, POSITION_STANDING, 20, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_camouflague },

 { /* 116 */ 12, POSITION_STANDING, 24, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_farsight },

 { /* 117 */ 12, POSITION_STANDING, 20, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_freefloat },

 { /* 118 */ 12, POSITION_STANDING, 33, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_insomnia },

 { /* 119 */ 12, POSITION_STANDING, 50, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_shadowslip },
    
 { /* 120 */ 12, POSITION_STANDING, 33, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_resist_energy },
...
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_staunchblood },
 ...
 { /* 124 */ 12, POSITION_FIGHTING, 22, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_OBJ_ROOM, cast_dispel_minor },

 { /* 125 */ 12, POSITION_STANDING, 25, TAR_IGNORE, spell_release_golem },

 { /* 126 */ 12, POSITION_FIGHTING, 30, TAR_IGNORE, spell_beacon },

 { /* 127 */ 12, POSITION_STANDING, 40, TAR_CHAR_ROOM|TAR_SELF_DEFAULT, 
cast_stone_shield },

 { /* 128 */ 18, POSITION_STANDING, 55, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_greater_stone_shield },

 { /* 129 */ 12, POSITION_FIGHTING, 15, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_iron_roots },

 { /* 130 */ /* 12, POSITION_STANDING, 50, 
TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_eyes_of_the_eagle */ 0, 
0, 0, 0, 0 },

 { /* 131 */ /* 12, POSITION_STANDING,  0, TAR_CHAR_ROOM, NULL */ 0, 0, 0, 
0, 0 },

 { /* 132 */ /* 12, POSITION_FIGHTING, 25, 
TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_ice_shards */ 0, 0, 0, 0, 
0 },

 { /* 133 */ 18, POSITION_STANDING, 65, TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_lightning_shield },

 { /* 134 */  9, POSITION_FIGHTING, 10, TAR_CHAR_ROOM|TAR_FIGHT_VICT|TAR_SELF_NONO, cast_blue_bird },
 ...
 { /* 140 */ 12, POSITION_STANDING, 15, TAR_CHAR_ROOM|TAR_SELF_ONLY|TAR_SELF_DEFAULT, cast_dismiss_corpse },
