...
bool put_obj_in_store( struct obj_data *obj, struct char_data *ch, FILE *fpsave, int wear_pos);
...
int save_pc_or_mob_data(struct char_data *ch, FILE * fpsave, struct time_data tmpage)
{
  if(IS_MOB(ch))
...
int char_to_store_variable_data(struct char_data * ch, FILE * fpsave)
{
...
void read_skill(struct char_data *ch, FILE *fpsave)
{
