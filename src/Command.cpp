...
const QList<Command> Commands::commands_ =
    {
        ...
        Command(QStringLiteral("drink"), &Character::do_drink, position_t::RESTING, 0, cmd_t::DEFAULT, true, 25, CommandType::all),
        Command(QStringLiteral("drop"), do_drop, position_t::RESTING, 0, cmd_t::DROP, true, 25, CommandType::all),
        Command(QStringLiteral("eat"), &Character::do_eat, position_t::RESTING, 0, cmd_t::DEFAULT, true, 25, CommandType::all),
