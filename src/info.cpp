...
int do_score(struct char_data *ch, char *argument, int cmd)
{
   ...
   if(!IS_NPC(ch)) // mobs can't view this part
   {
     sprintf(buf,
      ...
      "|o|   $3Armor$7:   %5d $3Pkills$7:  %5ld |~|    $3Items Carried$7:  %-3d/(%-3d)       |/|\n\r"
      "|\\|   $3RDeaths$7: %5ld $3PDeaths$7: %5ld |/|    $3Weight Carried$7: %-3d/(%-4d)      |~|\n\r"
      "|~|   $3BonusHit$7: %+4d $3BonusDam$7: %+4d |o|    $3Experience$7:     %-10ld      |\\|\n\r"
