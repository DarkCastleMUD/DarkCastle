...
public:
  ...
  void AddRoom(Character *ch, room_t room);
  void RemoveRoom(Character *ch, room_t room);
  ...
  bool IsAuctionHouse(room_t room);
...
public:
  ...
  void setZoneClanGold(zone_t zone_key, gold_t gold);
  void setZoneTopRoom(zone_t zone_key, room_t room_key);
  void setZoneBottomRoom(zone_t zone_key, room_t room_key);
  void setZoneModified(zone_t zone_key);
  void setZoneNotModified(zone_t zone_key);
  void incrementZoneDiedTick(zone_t zone_key);
  void resetZone(zone_t zone_key, Zone::ResetType reset_type = Zone::ResetType::normal);
  ...
  void set_zone_saved_zone(room_t room);
  void set_zone_modified_zone(room_t room);
  ...
  void set_zone_modified_world(room_t room);
  ...
  void set_zone_saved_world(room_t room);
