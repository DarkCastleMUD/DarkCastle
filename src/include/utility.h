 ...
 ***************************************************************************/
/* $Id: utility.h,v 1.14 2002/10/23 11:50:54 pirahna Exp $ */
...
#define IS_THIEF(ch)   (ISMOB(ch) ? 0 : IS_SET((ch)->pcdata->toggles, PLR_ISTHIEF))
#define IS_KILLER(ch)  (ISMOB(ch) ? 0 : IS_SET((ch)->pcdata->toggles, PLR_ISKILLER))
