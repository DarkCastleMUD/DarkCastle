...
#else /* !_STYPES_LATER, new_new ABI */
...
#if defined (_KERNEL) && defined (__sgi) /* Trusted IRIX */
struct mac_label;
 ...
 */
struct opproc {
	int	level;  	/* options level ths function handles */
...
/*
 * This structure is used for adding new_new protocols to the list supported by
 * sockets.
 */

struct socknew_newproto {
