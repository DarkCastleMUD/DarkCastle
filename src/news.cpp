...
void savenews()
{
  ...
  {
    logentry(QStringLiteral("Cannot open news file 'news.data'"), 0, LibDC::LogChannels::LOG_MISC);
    abort();
  }
  ...
  if (std::system(0))
    ...
    logentry(QStringLiteral("Cannot save news file to web dir."), 0, LibDC::LogChannels::LOG_MISC);
}
