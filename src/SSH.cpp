...
namespace SSH
{
  ...
  void SSH::setup(void)
  {
    ...
    logf(0, LibDC::LogChannels::LOG_BUG, "cwd is %s", buffer);
    chdir("../lib");
    ...
    {
      logf(0, LibDC::LogChannels::LOG_BUG, "ssh_bind_options_parse_config returned %d", rc);
    }
    ...
    {
      logf(0, LibDC::LogChannels::LOG_BUG, "ssh_bind_options_set SSH_BIND_OPTIONS_BINDPORT returned %d", rc);
    }
    ...
    {
      logf(0, LibDC::LogChannels::LOG_BUG, "ssh_bind_listen returned %d", rc);
    }
  }
