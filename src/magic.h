...
typedef  int (*SPELL_POINTER) (uint8_t, Character*, char*, int, Character*, struct obj_data *,int);
...
int spell_iridescent_aura(uint8_t level, Character *ch,
    Character *victim, struct obj_data *obj, int skill);
...
int spell_animate_dead(uint8_t level, Character * ch,
   Character * victim, struct obj_data * corpse, int skill);
...
int spell_conjure_elemental(uint8_t level, Character * ch,
   char *arg, Character * victim, struct obj_data * obj, int skill);
...
int spell_know_alignment(uint8_t level, Character * ch,
   Character * victim, struct obj_data * obj, int skill);
int spell_dispel_magic(uint8_t level, Character * ch, Character * victim, struct obj_data * obj, int skill, int spell = 0);
