                      ...
                      Character *invoker)
{
  ...
  default:
    ...
    logf(IMMORTAL, LogChannels::LOG_WORLD, "'Push' proc on obj %d without entry in proc table. (push_proc)\r\n", obj_vnum);
    break;
  }
...
int pull_proc(Character *ch, class Object *obj, int cmd, const char *arg, Character *invoker)
{
  ...
  default:
    ...
    logf(IMMORTAL, LogChannels::LOG_WORLD, "'Pull' proc on obj %d without entry in proc table. (pull_proc)\r\n", obj_vnum);
    break;
  }
...
int hornoplenty(Character *ch, class Object *obj, int cmd, const char *arg, Character *invoker)
{
  ...
  if (objnum < 0)
  {
    logf(IMMORTAL, LogChannels::LOG_BUG, "Horn o plenty load obj incorrent.");
    return eFAILURE;
  }
...
int exploding_mortar_shells(Character *ch, class Object *obj, int cmd, const char *arg, Character *invoker)
{
  ...
  if (obj->in_room <= 0)
  {
    logentry(QStringLiteral("Mortar round without a room?"), IMMORTAL, LogChannels::LOG_BUG);
    extract_obj(obj);
    return eFAILURE;
  }
