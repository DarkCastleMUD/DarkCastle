...
struct assembler_data gem_data[] = {
   ...
   { "You carefully sand down the pointy stick, adding to its excellent form.\r\n  Splitting the feathers down, you 
carefully attach them to the pointy stick.\r\n  Finally, you shape the scorpion stinger into a deadly arrowhead and 
secure it to the front.\r\n",
