 ...
 * of just race stuff                                                     *
 **************************************************************************
 * $Id: fight.cpp,v 1.504 2008/11/09 21:22:15 kkoons Exp $               *
 **************************************************************************/
...
void group_gain(CHAR_DATA * ch, CHAR_DATA * victim)
{
  ...
  { 
    ...
    if(GET_LEVEL(tmp_ch) - GET_LEVEL(highest) <= -25 && !IS_NPC(tmp_ch)) {
...
int weapon_spells(CHAR_DATA *ch, CHAR_DATA *vict, int weapon)
{
  ...
  for(i = 0; i < weap->num_affects; i++)
  {
    ...
    case WEP_CREATE_FOOD:
      ...
      break;
    case WEP_WILD_MAGIC:
      retval = cast_wild_magic(GET_LEVEL(ch), ch, "offense", 0, vict, NULL, wep_skill);
      break;
/*
