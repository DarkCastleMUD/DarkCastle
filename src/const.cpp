...
/*                       spell list                                       */
/**************************************************************************/
/* $Id: const.cpp,v 1.245 2007/06/11 14:05:20 apocalypse Exp $ */
...
/*  1 */{    500,     5,  1,  1,  100,     250},
/*  2 */{    750,     7,  2,  1,   98,     500},
/*  3 */{   1000,    10,  3,  1,   96,     750},
/*  4 */{   2000,    20,  4,  2,   94,    1000},
/*  5 */{   3000,    30,  5,  2,   92,    1250},
/*  6 */{   4000,    40,  6,  2,   90,    1500},
/*  7 */{   5000,    50,  7,  3,   87,    1750},
/*  8 */{   6500,    65,  8,  3,   84,    2000},
/*  9 */{   8000,    80,  9,  3,   81,    2250},
/* 10 */{  11000,   100, 10,  4,   78,    2500},
/* 11 */{  14000,   120, 11,  4,   74,    3000},
/* 12 */{  17000,   140, 12,  5,   70,    3500},
/* 13 */{  20000,   160, 13,  5,   68,    4000},
/* 14 */{  30000,   180, 14,  6,   64,    4500},
/* 15 */{  40000,   200, 15,  7,   60,    5000},
/* 16 */{  50000,   225, 16,  9,   56,    5500},
/* 17 */{  60000,   250, 17, 11,   52,    6000},
/* 18 */{  70000,   275, 18, 12,   48,    6500},
/* 19 */{  80000,   300, 19, 13,   44,    7000},
/* 20 */{  90000,   325, 20, 15,   40,    7500},
/* Lowbie Range Above Here */
/* 21 */{ 100000,   350, 21, 16,   36,    8000},
/* 22 */{ 110000,   375, 22, 17,   32,    8750},
/* 23 */{ 120000,   400, 23, 18,   28,    9500},
/* 24 */{ 130000,   425, 24, 19,   24,   10250},
/* 25 */{ 140000,   450, 25, 20,   20,   11000},
/* 26 */{ 150000,   475, 26, 20,   16,   11750},
/* 27 */{ 160000,   500, 27, 21,   12,   12500},
/* 28 */{ 170000,   525, 28, 21,    8,   13250},
/* 29 */{ 180000,   550, 29, 22,    4,   14000},
/* 30 */{ 190000,   575, 30, 22,    0,   15000},
/* 31 */{ 200000,   600, 31, 23,   -4,   16000},
/* 32 */{ 220000,   640, 32, 23,   -8,   17000},
/* 33 */{ 240000,   680, 33, 24,  -12,   18000},
/* 34 */{ 260000,   720, 34, 24,  -16,   19000},
/* 35 */{ 280000,   760, 35, 25,  -20,   20000},
/* 36 */{ 300000,   800, 36, 26,  -24,   21500},
/* 37 */{ 325000,   850, 37, 27,  -28,   23000},
/* 38 */{ 350000,   900, 38, 28,  -32,   24500},
/* 39 */{ 375000,   950, 39, 29,  -36,   26000},
/* Midbie Range Above Here */
/* 40 */{ 400000,  1000, 40, 20,  -40,   27500},
/* 41 */{ 425000,  1050, 41, 31,  -45,   30000},
/* 42 */{ 450000,  1100, 42, 32,  -50,   32500},
/* 43 */{ 475000,  1150, 43, 33,  -55,   35000},
/* 44 */{ 500000,  1200, 44, 34,  -60,   37500},
/* 45 */{ 550000,  1250, 45, 35,  -65,   40000},
/* 46 */{ 600000,  1300, 46, 36,  -70,   42500},
/* 47 */{ 650000,  1350, 47, 37,  -75,   45000},
/* 48 */{ 700000,  1400, 48, 38,  -80,   47500},
/* 49 */{ 750000,  1450, 49, 39,  -85,   50000},
/* 50 */{ 800000,  1500, 50, 40,  -90,   55000},
/* 51 */{1000000,  1600, 51, 41,  -95,   60000},
/* 52 */{1050000,  1700, 52, 42, -100,   65000},
/* 53 */{1100000,  1800, 53, 43, -105,   70000},
/* 54 */{1150000,  1900, 54, 44, -110,   75000},
/* 55 */{1200000,  2000, 55, 45, -115,   80000},
/* 56 */{1250000,  2100, 56, 46, -120,   85000},
/* 57 */{1300000,  2200, 57, 47, -125,   90000},
/* 58 */{1350000,  2300, 58, 48, -130,   95000},
/* 59 */{1400000,  2400, 59, 49, -135,  100000},
/* 60 */{1500000,  2500, 60, 50, -140,  105000},
/* 61 */{1600000,  2600, 61, 51, -146,  110000},
/* 62 */{1700000,  2700, 62, 52, -154,  115000},
/* 63 */{1800000,  2800, 63, 53, -162,  120000},
/* 64 */{1900000,  2900, 64, 54, -170,  125000},
/* 65 */{2000000,  3000, 65, 55, -178,  130000},
/* 66 */{2100000,  3200, 66, 56, -186,  135000},
/* 67 */{2200000,  3400, 67, 57, -194,  140000},
/* 68 */{2300000,  3600, 68, 58, -202,  145000},
/* 69 */{2400000,  3800, 69, 59, -210,  150000},
/* 70 */{2500000,  4000, 70, 60, -218,  155000},
/* 71 */{2600000,  4250, 71, 61, -226,  160000},
/* 72 */{2700000,  4500, 72, 62, -234,  165000},
/* 73 */{2800000,  4750, 73, 63, -242,  170000},
/* 74 */{2900000,  5000, 74, 64, -250,  175000},
/* High Level and 50+ Range Above Here */
/* ------ EQ Mob Range Starts Here ------    */
/* 75 */{5000000,  6000, 75, 65, -500,  300000},
/* 76 */{5100000,  6250, 76, 66, -510,  325000},
/* 77 */{5200000,  6500, 77, 67, -520,  350000},
/* 78 */{5300000,  6750, 78, 68, -530,  375000},
/* 79 */{5400000,  7000, 79, 69, -540,  400000},
/* 80 */{5500000,  7500, 80, 70, -550,  450000},
/* 81 */{5600000,  8000, 81, 71, -560,  500000},
/* 82 */{5700000,  8500, 82, 72, -570,  600000},
/* 83 */{5800000,  9000, 83, 73, -580,  700000},
/* 84 */{5900000,  9500, 84, 74, -590,  800000},
/* 85 */{6000000, 10000, 85, 75, -600,  900000},
/* 86 */{6100000, 10250, 86, 76, -610, 1000000},
/* 87 */{6200000, 10500, 87, 77, -620, 1250000},
/* 88 */{6300000, 11000, 88, 78, -630, 1500000},
/* 89 */{6400000, 11500, 89, 79, -640, 1750000},
/* 90 */{6500000, 12000, 90, 80, -650, 2000000},
/* 91 */{6600000, 12500, 91, 81, -660, 2250000},
/* 92 */{6700000, 13000, 92, 82, -670, 2500000},
/* 93 */{6800000, 13500, 93, 83, -680, 2750000},
/* 94 */{7000000, 14000, 94, 84, -690, 3250000},
/* 95 */{7250000, 15000, 95, 85, -700, 3500000},
/* 96 */{7500000, 16000, 96, 86, -710, 3750000},
/* 97 */{7750000, 17000, 97, 87, -720, 4000000},
/* 98 */{8000000, 18000, 98, 88, -730, 4250000},
/* 99 */{8250000, 19000, 99, 89, -740, 4500000},
/*100 */{8500000, 20000,100, 90, -750, 5000000},
/*101 */{8750000, 21000,101, 91, -775, 5250000},
/*102 */{9000000, 22000,102, 92, -800, 5500000},
/*103 */{9250000, 23000,103, 93, -825, 5750000},
/*104 */{9500000, 24000,104, 94, -850, 6000000},
/*105 */{9750000, 25000,105, 95, -875, 6250000},
/*106 */{10000000,26000,106, 96, -900, 6500000},
/*107 */{10250000,27000,107, 97, -925, 6750000},
/*108 */{10500000,28000,108, 98, -950, 7000000},
/*109 */{10750000,29000,109, 99, -975, 7250000},
