...
/*                       spell list                                       */
/**************************************************************************/
/* $Id: const.cpp,v 1.238 2007/04/13 11:08:56 shane Exp $ */
...
{    "headbutt",        SKILL_HEADBUTT,           12,   85,     STRDEX },
...
{"enhanced regeneration",SKILL_ENHANCED_REGEN,    22,   75,     STRCON },
...
{    "archery",         SKILL_ARCHERY,            32,   55,     CONWIS },
...
{    "slashing",        SKILL_SLASHING_WEAPONS, 30,     55,   CONINT },
...
{    "invisibility",         SPELL_INVISIBLE,         13,     90,     DEXINT },
...
{    "dismiss corpse",       SPELL_DISMISS_CORPSE,    29,     80,     CONWIS },
...
{    "unholy aegis",         SPELL_U_AEGIS,           44,     90,     CONINT },
{    "protection from good", SPELL_PROTECT_FROM_GOOD, 45,     90,     CONINT },
...
{    "detect poison",        SPELL_DETECT_POISON,      11,     90,     STRWIS },
...
{    "remove poison",        SPELL_REMOVE_POISON,      18,     90,     CONWIS },
...
{    "two handers",          SKILL_TWO_HANDED_WEAPONS, 35,     75,     DEXINT },
{    "heal",                 SPELL_HEAL,               37,     85,     INTWIS },
{    "harm",                 SPELL_HARM,               38,     85,     STRCON },
{    "sanctuary",            SPELL_SANCTUARY,          40,     90,     CONWIS },
{    "holy aegis",           SPELL_AEGIS,              42,     90,     STRWIS },
{    "dispel evil",          SPELL_DISPEL_EVIL,        43,     90,     STRCON },
{    "protection from evil", SPELL_PROTECT_FROM_EVIL,  45,     90,     CONWIS },
...
//   Ability Name       Ability File            Level  Max   Requisites
//   ------------       ------------            -----  ---   ----------
{    "dual wield",      SKILL_DUAL_WIELD,         1,    90,  DEXWIS },
{    "bash",            SKILL_BASH,               2,    90,  STRINT },
{    "kick",            SKILL_KICK,               3,    80,  STRINT },
{    "parry",           SKILL_PARRY,              5,    80,  DEXCON },
{    "double",          SKILL_SECOND_ATTACK,      8,    85,  DEXWIS },
{    "dodge",           SKILL_DODGE,  	          10,   80,  DEXCON },
...
{    "blindfighting",   SKILL_BLINDFIGHTING,      28,   65,  DEXCON },
...
{    "blindfighting",   SKILL_BLINDFIGHTING,    38,     85,     CONWIS },
...
{    "eyes of the owl", SPELL_EYES_OF_THE_OWL,   8,      90,     STRCON },
{    "sense life",      SPELL_SENSE_LIFE,        9,      90,     CONWIS },
{    "dodge",    	SKILL_DODGE,    	 10,     50,     CONWIS },
...
{    "disarm",          SKILL_DISARM,            42,     70,     CONWIS },
{    "staunchblood",    SPELL_STAUNCHBLOOD,      44,     70,     CONWIS },
{    "forest meld",     SPELL_FOREST_MELD,       45,     90,     INTWIS },
{    "camouflage",      SPELL_CAMOUFLAGE,        46,     90,     INTWIS },
...
{    "eyes of the owl",      SPELL_EYES_OF_THE_OWL,      2,      85,     DEXWIS },
...
{    "whipping",             SKILL_WHIPPING_WEAPONS,     30,     70,     STRDEX },
{    "crushing",             SKILL_CRUSHING_WEAPONS,     30,     70,     STRDEX },
{    "bludgeoning",          SKILL_BLUDGEON_WEAPONS,     30,     70,     STRDEX },
...
{    "barkskin",             SPELL_BARKSKIN,             37,     85,     STRCON },
...
{    "stoneskin",            SPELL_STONE_SKIN,           44,     70,     STRCON },
...
{    "know alignment",       SPELL_KNOW_ALIGNMENT,    5,      90,     DEXINT },
{    "detect magic",         SPELL_DETECT_MAGIC,      6,      85,     DEXINT },
...
{    "dispel minor",         SPELL_DISPEL_MINOR,      14,     85,     STRCON },
...
{    "locate object",        SPELL_LOCATE_OBJECT,     23,     80,     DEXINT },
...
{    "bludgeoning",          SKILL_BLUDGEON_WEAPONS,  30,     80,     STRINT },
{    "crushing",             SKILL_CRUSHING_WEAPONS,  30,     80,     STRINT },
...
{    "portal",               SPELL_PORTAL,            38,     85,     DEXWIS },
...
{    "dispel magic",         SPELL_DISPEL_MAGIC,      45,     85,     STRCON },
...
{    "armor",               SPELL_ARMOR,             7,      80,     CONWIS },
{    "continual light",     SPELL_CONT_LIGHT,        8,      80,     STRCON },
...
{    "strength",            SPELL_STRENGTH,          13,     85,     DEXINT },
{    "fear",                SPELL_FEAR,              15,     90,     CONWIS },
{    "identify",            SPELL_IDENTIFY,          16,    100,     INTWIS },
{    "locate object",       SPELL_LOCATE_OBJECT,     17,     90,     INTWIS },
{    "call familiar",       SPELL_SUMMON_FAMILIAR,   18,     90,     STRCON },
{    "dismiss familiar",    SPELL_DISMISS_FAMILIAR,  18,     90,     STRCON },
...
{    "piercing",            SKILL_PIERCEING_WEAPONS, 30,     55,     DEXINT },
{    "bludgeoning",         SKILL_BLUDGEON_WEAPONS,  30,     55,     DEXINT },
{    "resist magic",        SPELL_RESIST_MAGIC,      31,     90,     CONWIS },
{    "haste",               SPELL_HASTE,             33,    100,     DEXINT },
{    "true sight",          SPELL_TRUE_SIGHT,        34,     85,     INTWIS },
{    "dispel magic",        SPELL_DISPEL_MAGIC,      35,     85,     CONWIS },
...
{    "word of recall",      SPELL_WORD_OF_RECALL,    42,     85,     DEXWIS },
