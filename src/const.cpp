...
/*                       spell list                                       */
/**************************************************************************/
/* $Id: const.cpp,v 1.247 2007/07/03 19:41:28 apocalypse Exp $ */
...
/*  4 */{   2000,    20,  2,  2,   94,    1000},
/*  5 */{   3000,    30,  2,  2,   92,    1250},
/*  6 */{   4000,    40,  2,  2,   90,    1500},
/*  7 */{   5000,    50,  3,  3,   87,    1750},
/*  8 */{   6500,    65,  3,  3,   84,    2000},
/*  9 */{   8000,    80,  3,  3,   81,    2250},
/* 10 */{  11000,   100,  4,  4,   78,    2500},
/* 11 */{  14000,   120,  4,  4,   74,    3000},
/* 12 */{  17000,   140,  5,  5,   70,    3500},
/* 13 */{  20000,   160,  5,  5,   68,    4000},
/* 14 */{  30000,   180,  6,  6,   64,    4500},
/* 15 */{  40000,   200,  7,  7,   60,    5000},
/* 16 */{  50000,   225,  9,  9,   56,    5500},
/* 17 */{  60000,   250, 11, 11,   52,    6000},
/* 18 */{  70000,   275, 12, 12,   48,    6500},
/* 19 */{  80000,   300, 13, 13,   44,    7000},
/* 20 */{  90000,   325, 15, 15,   40,    7500},
/* Lowbie Range Above Here */
/* 21 */{ 100000,   350, 16, 16,   36,    8000},
/* 22 */{ 110000,   375, 17, 17,   32,    8750},
/* 23 */{ 120000,   400, 18, 18,   28,    9500},
/* 24 */{ 130000,   425, 19, 19,   24,   10250},
/* 25 */{ 140000,   450, 20, 20,   20,   11000},
/* 26 */{ 150000,   475, 20, 20,   16,   11750},
/* 27 */{ 160000,   500, 21, 21,   12,   12500},
/* 28 */{ 170000,   525, 21, 21,    8,   13250},
/* 29 */{ 180000,   550, 22, 22,    4,   14000},
/* 30 */{ 190000,   575, 22, 22,    0,   15000},
/* 31 */{ 200000,   600, 23, 23,   -4,   16000},
/* 32 */{ 220000,   640, 23, 23,   -8,   17000},
/* 33 */{ 240000,   680, 24, 24,  -12,   18000},
/* 34 */{ 260000,   720, 24, 24,  -16,   19000},
/* 35 */{ 280000,   760, 25, 25,  -20,   20000},
/* 36 */{ 300000,   800, 26, 26,  -24,   21500},
/* 37 */{ 325000,   850, 27, 27,  -28,   23000},
/* 38 */{ 350000,   900, 28, 28,  -32,   24500},
/* 39 */{ 375000,   950, 29, 29,  -36,   26000},
/* Midbie Range Above Here */
/* 40 */{ 400000,  1000, 30, 30,  -40,   27500},
/* 41 */{ 425000,  1050, 31, 31,  -45,   30000},
/* 42 */{ 450000,  1100, 32, 32,  -50,   32500},
/* 43 */{ 475000,  1150, 33, 33,  -55,   35000},
/* 44 */{ 500000,  1200, 34, 34,  -60,   37500},
/* 45 */{ 550000,  1250, 35, 35,  -65,   40000},
/* 46 */{ 600000,  1300, 36, 36,  -70,   42500},
/* 47 */{ 650000,  1350, 37, 37,  -75,   45000},
/* 48 */{ 700000,  1400, 38, 38,  -80,   47500},
/* 49 */{ 750000,  1450, 39, 39,  -85,   50000},
/* 50 */{ 800000,  1500, 40, 40,  -90,   55000},
/* 51 */{1000000,  1600, 41, 41,  -95,   60000},
/* 52 */{1050000,  1700, 42, 42, -100,   65000},
/* 53 */{1100000,  1800, 43, 43, -105,   70000},
/* 54 */{1150000,  1900, 44, 44, -110,   75000},
/* 55 */{1200000,  2000, 45, 45, -115,   80000},
/* 56 */{1250000,  2100, 46, 46, -120,   85000},
/* 57 */{1300000,  2200, 47, 47, -125,   90000},
/* 58 */{1350000,  2300, 48, 48, -130,   95000},
/* 59 */{1400000,  2400, 49, 49, -135,  100000},
/* 60 */{1500000,  2500, 50, 50, -140,  105000},
/* 61 */{1600000,  2600, 51, 51, -146,  110000},
/* 62 */{1700000,  2700, 52, 52, -154,  115000},
/* 63 */{1800000,  2800, 53, 53, -162,  120000},
/* 64 */{1900000,  2900, 54, 54, -170,  125000},
/* 65 */{2000000,  3000, 55, 55, -178,  130000},
/* 66 */{2100000,  3200, 56, 56, -186,  135000},
/* 67 */{2200000,  3400, 57, 57, -194,  140000},
/* 68 */{2300000,  3600, 58, 58, -202,  145000},
/* 69 */{2400000,  3800, 59, 59, -210,  150000},
/* 70 */{2500000,  4000, 60, 60, -218,  155000},
/* 71 */{2600000,  4250, 61, 61, -226,  160000},
/* 72 */{2700000,  4500, 62, 62, -234,  165000},
/* 73 */{2800000,  4750, 63, 63, -242,  170000},
/* 74 */{2900000,  5000, 64, 64, -250,  175000},
