...
int innate_powerwield (struct char_data *ch, char *argument, int cmd);
int innate_regeneration (struct char_data *ch, char *argument, int cmd);
int innate_illusion (struct char_data *ch, char *argument, int cmd);
int innate_repair (struct char_data *ch, char *argument, int cmd);
int innate_focus (struct char_data *ch, char *argument, int cmd);
int innate_evasion (struct char_data *ch, char *argument, int cmd);
int innate_shadowslip (struct char_data *ch, char *argument, int cmd);
int innate_bloodlust (struct char_data *ch, char *argument, int cmd);
int innate_fly (struct char_data *ch, char *argument, int cmd);
...
////////////////////////////////////////////////////////////////////////////
// command functions
int do_innate(struct char_data *ch, char *arg, int cmd)
{
  if(ch && ch->in_room > 0 &&
...
int innate_regeneration(struct char_data *ch, char *arg, int cmd)
{
   struct affected_type af;
...
int innate_powerwield(struct char_data *ch, char *arg, int cmd)
{
   struct affected_type af;
...
int innate_focus(struct char_data *ch, char *arg, int cmd)
{
...
int innate_illusion(struct char_data *ch, char *arg, int cmd)
{
...
int innate_bloodlust(struct char_data *ch, char *arg, int cmd)
{
  if (!ch->fighting)
  {
...
int innate_repair(struct char_data *ch, char *arg, int cmd)
{
  struct obj_data *obj;
...
int innate_evasion(struct char_data *ch, char *arg, int cmd)
{
   struct affected_type af;
...
int innate_shadowslip(struct char_data *ch, char *arg, int cmd)
{
   struct affected_type af;
...
int innate_fly(struct char_data *ch, char *arg, int cmd)
{
