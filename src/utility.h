...
void parse_bitstrings_into_int(const char * bits[], const char * strings, char_data * ch, uint64_t value[]);
void parse_bitstrings_into_int(const char * bits[], const char * strings, char_data * ch, uint64_t & value);
...
void parse_bitstrings_into_int(const char * bits[], string strings, char_data * ch, uint64_t value[]);
void parse_bitstrings_into_int(const char * bits[], string strings, char_data * ch, uint64_t & value);
