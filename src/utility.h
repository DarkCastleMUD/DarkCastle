...
void parse_bitstrings_into_int(const char * bits[], string strings, char_data * ch, uint32 value[]);
void parse_bitstrings_into_int(const char * bits[], string strings, char_data * ch, uint32 & value);
void parse_bitstrings_into_int(const char * bits[], string strings, char_data * ch, uint16 & value);
