...
*                        coded list.                                      *
***************************************************************************/
/* $Id: nanny.cpp,v 1.98 2005/06/21 19:00:06 shane Exp $ */
extern "C" {
#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>
...
void update_command_lag_and_poison()
{
   ...
   for(i = character_list; i; i = next_dude) 
   {
      ...
      // handle drowning
      if (!IS_NPC(i) && GET_LEVEL(i) < IMMORTAL && world[i->in_room].sector_type == SECT_UNDERWATER && !affected_by_spell(i, SPELL_WATER_BREATHING)) {
         tmp = GET_MAX_HIT(i) / 5;
